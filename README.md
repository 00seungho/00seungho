...
- **프로젝트 개요**: 생필품과 가전제품은 온라인으로 쉽게 구매할 수 있지만, 화장품은 그렇지 않다는 문제의식에서 시작된 프로젝트입니다.  
- **주요 기능**: 
  - RealGlow 어플리케이션을 통해 소비자는 화장품의 **실제 효과를 시각적으로 확인**할 수 있습니다.  
  - 온라인에서도 **자신에게 적합한 제품을 선택**하여 구매할 수 있도록 돕고, **구매 링크를 제공**합니다.  
...
- **프로젝트 개요**: 신조어로 인한 세대 간 **언어 소통 문제를 해결**하기 위한 프로젝트입니다.  
- **주요 기능**: 
  - **한국어 LLM 모델**을 활용하여 신조어를 **평문으로 번역**합니다.  
  - 웹 사이트를 통해 사용자는 **간단한 UI로 신조어의 의미**를 쉽게 확인할 수 있습니다.  
  - 사용자 접근성을 높이기 위해 **웹 기반의 서비스**로 제공됩니다.  
...
- **프로젝트 개요**: **교통약자를 위한 지하철 편의시설 조회**와 **저상버스 도착 정보**를 제공하기 위해 시작한 프로젝트입니다.  
- **주요 기능**: 
  - **서울 열린데이터 광장 API**와 **kakaoMap API**를 활용하여 교통 약자를 위한 **편의시설 정보 조회 서비스**를 제공합니다.  
  - **저상버스 도착 정보**를 실시간으로 조회할 수 있습니다.  
...
- **프로젝트 개요**: **SpringBoot**를 이용한 커뮤니티형 웹 서비스 프로젝트입니다.  
- **주요 기능**: 
  -  
  -
...
#### 2. [빵먹는아이 봇](https://github.com/00seungho/discord-bbangbot)  
> **디스코드 봇 어플리케이션**  
...
- **프로젝트 개요**: **디스코드 API와 게임 API**를 활용하여 만든 **디스코드 봇** 어플리케이션입니다.  
- **주요 기능**: 
  - 게임 사이트의 **API를 활용한 다양한 기능**을 디스코드 플랫폼에 제공합니다.  
  - 디스코드에서 **커뮤니티와의 소통 및 게임 정보 제공**에 활용됩니다.  

---

#### 3. [밈생성기](https://github.com/00seungho/meme-generator/tree/main)  
> **MEME 생성 웹 어플리케이션**  
...
- **프로젝트 개요**: **MEME 생성기**는 사용자가 입력한 텍스트와 이미지를 조합하여 **밈을 생성**할 수 있는 웹 어플리케이션입니다.  
- **주요 기능**: 
  - **PIL 모듈**을 사용하여 사용자가 입력한 텍스트를 이미지에 삽입합니다.  
  - **Flask 웹 프레임워크**를 이용해 사용자와의 **인터랙션을 제공**하는 웹 어플리케이션입니다.  

---

#### 4. [지구근접물체 탐색기](https://github.com/00seungho/Close-Approaches-of-Near-Earth-Objects)  
> **CLI 기반의 지구근접물체 탐색기**  
> <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=Python&logoColor=white"/>

- **프로젝트 개요**: **지구근접물체(NEO, Near-Earth Object) 탐색기**는 우주 물체의 궤도를 조회할 수 있는 **CLI(명령줄 인터페이스) 어플리케이션**입니다.  
- **주요 기능**: 
  - 사용자는 **쿼리(검색 조건)를 입력**하여 특정 지구근접물체의 궤도를 조회할 수 있습니다.  
  - **파일 입출력 기능**을 통해 조회된 정보를 **저장하고 다시 불러올 수 있는 기능**이 포함되어 있습니다.  

---

#### 4. [Movie Story](https://github.com/00seungho/movie_story)  
...
- **프로젝트 개요**: **HTML과 자바스크립트를 활용한 웹 프론트엔드 실습 프로젝트**입니다.  
- **주요 기능**: 
  - **HTML과 JavaScript로 인터랙션을 구현**하였습니다.  
  - 프론트엔드의 **기본적인 이벤트 처리 및 데이터 출력**을 학습하고 실습한 프로젝트입니다.  
